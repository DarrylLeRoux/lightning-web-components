...
export default class AssetSelection extends LightningElement {
  ...
  get options() {
    return [
        ...
        { label: 'people_add', folder:"09.People/", value: 'icn_people_1_add.svg' },
        { label: 'people_approved', folder:"09.People/", value: 'icn_people_1_approved.svg' },
        { label: 'people_edit', folder:"09.People/", value: 'icn_people_1_edit.svg' },
        { label: 'people_fail', folder:"09.People/", value: 'icn_people_1_edit.svg' },
        { label: 'people_international', folder:"09.People/", value: 'icn_people_1_international.svg' },
        { label: 'people_lock', folder:"09.People/", value: 'icn_people_1_lock.svg' },
        { label: 'people_nametag', folder:"09.People/", value: 'icn_people_1_nametage.svg' },
        { label: 'people_remove', folder:"09.People/", value: 'icn_people_1_remove.svg' },
        { label: 'people_international',folder:"09.People/",  value: 'icn_people_1_international.svg' },
        { label: 'people_settings',folder:"09.People/", value: 'icn_people_1_settings.svg' },
        { label: 'people_stars', folder:"09.People/", value: 'icn_people_1_stars.svg' },
        { label: 'people_strike', folder:"09.People/", value: 'icn_people_1_strike.svg' },
        { label: 'people_1', folder:"09.People/", value: 'icn_people_1.svg' },
        { label: 'people_2_add', folder:"09.People/", value: 'icn_people_2_add.svg' },
        { label: 'people_2',folder:"09.People/",  value: 'icn_people_2.svg' },
        { label: 'people_3_add',folder:"09.People/", value: 'icn_people_3_add.svg' },
        { label: 'people_3', folder:"09.People/", value: 'icn_people_3.svg' },
        { label: 'people_collaboration', folder:"09.People/", value: 'icn_people_collaboration.svg' },
        { label: 'people_hand', folder:"09.People/", value: 'icn_people_hand.svg' },
        { label: 'people_profile', folder:"09.People/", value: 'icn_people_profile.svg' },
    ];
  } 
